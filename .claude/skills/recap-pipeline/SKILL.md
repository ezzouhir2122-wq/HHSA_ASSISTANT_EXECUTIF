---
name: recap-pipeline
description: Résumé complet du pipeline commercial depuis Google Sheets via Zapier. Affiche leads par étape, valeur active, et top 3 leads chauds.
allowed-tools: mcp__zapier__list_enabled_zapier_actions, mcp__zapier__discover_zapier_actions, mcp__zapier__enable_zapier_action, mcp__zapier__execute_zapier_read_action
---
